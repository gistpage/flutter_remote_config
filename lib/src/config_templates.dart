...
class ConfigTemplates {
  ...
  static Map<String, dynamic> enabledRedirectExample({
    ...
    String version = '1',
  }) => {'version': version, 'isRedirectEnabled': true, 'redirectUrl': url};
  ...
  static Map<String, dynamic> createDisabledRedirect({String version = '1'}) {
    return redirectConfig(version: version, isRedirectEnabled: false);
  }
  ...
  static Map<String, dynamic> toggleRedirect(
    ...
    return {
      ...
      'redirectUrl':
          newUrl ?? (isCurrentlyEnabled ? currentUrl : 'https://example.com'),
    };
  }
  ...
  /// 禁用重定向（恢复正常）
  static Map<String, dynamic> disableRedirect({String version = '1'}) => {
    'version': version,
    'isRedirectEnabled': false,
    'redirectUrl': '',
  };
